...
export default function Top({ op }) {
    return (
        <div className={`w-[1047px] h-[107px] absolute top-[36px] left-[246px] text-center text-white leading-[13.2px] font-bold text-[11px] opacity-${op}`}>
